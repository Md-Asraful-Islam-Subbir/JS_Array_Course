...
// How to Get Elements from an Array in JS
{
  ...
  for(let i=0; i<salad3.length; i++) {
    console.log(`Element at index ${i} is ${salad3[i]}`);
  }
}
...
{
  let [tomato1, mushroom1, carrot1] = ['🍅', '🍄', '🥕'];
  console.log(tomato1, mushroom1, carrot1); // Output, 🍅 🍄 🥕
...
// The indexOf() array method
{
  ...
  names1.indexOf('tom'); // returns 0
  names1.lastIndexOf('tom'); // returns 3
}
...
// The splice() array method
{
  ...
  names3.splice(1, 0, 'zack');
  
  console.log(names3); // ["tom", "zack", "alex", "bob"]
...
// The with() method
{
  ...
  numbers1[2] = 6;
  console.log(numbers1); // [1, 2, 6, 4, 5];

  const newArray = numbers.with(2,6);

  console.log(numbers1); // Unchanged => [1, 2, 3, 4, 5];
